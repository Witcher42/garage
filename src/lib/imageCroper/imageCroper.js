...
ImageCroper.prototype.initCroper = function (obj, opt) {
    ...
    var options = $.extend({}, defaultConfig),
        ...
        is_msie = /msie/.test(ua),
        ie6mode = /msie [1-6]\./.test(ua),
        $img;
    ...
    var Selection = (function () {
        ...
        function update(select) {
            ...
            if (select) {
                ...
                self.emit('select', unscale(c));
            } else {
                options.onChange.call(api, unscale(c));
                self.emit('change', unscale(c));
            }
        }
        ...
        function trackUp(e) {
            ...
            if (btndown) {
                ...
                if (Selection.isAwake()) {
                    ...
                    self.emit('select', unscale(Coords.getFixed()));
                }
